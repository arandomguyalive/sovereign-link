...
const FEEDS: Feed[] = [
  ...
  { id: 'CORE-RECON', source: 'https://www.youtube.com/embed/yv_YtP9XU6w?autoplay=1&mute=1&controls=0&modestbranding=1&rel=0&iv_load_policy=3', label: 'GRID-CORE // SECTOR-01', location: 'Core Grid, Sector 01', type: 'YOUTUBE', meta: { ip: '10.0.4.12', protocol: 'HTTP-FLV', encryption: 'AES-256' } },
